        ...
        <body>
            ...
            <nav class="navbar">
              ...
              <?php
                ...
                $sql = "INSERT INTO add_member(member_id,member_name,gender,email_address,contact_number,Role,member_location)
                VALUES('$memID',' $memname','$memgen','$mememail','$CTno','$memrole','$memloc')";
